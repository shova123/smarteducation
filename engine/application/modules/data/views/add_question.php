...
<!--                    <input type="hidden" value="<?php //if (!empty($isEdit)) {echo $details->token;} else {echo md5(uniqid(mt_rand(), True));}?>" name="token" />-->
                    ...
                    <!--<div class="row" id="first_form">-->
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4">
                                <select name="chapter_id" id="chapter_id" class='form-control'  onchange="setChapter(document.addEditform.chapter_id.options[document.addEditform.chapter_id.selectedIndex].value);">
                        ...
                        <div style="background-color: #ddd; ">
                            <div class="form-group col-sm-6 my-form-element">
                                ...
                                <select name="question_set" value="question_set">
                                    ...
                                    <option value="D" <?php if (!empty($isEdit)) {if ($details->question_set == "D") { ?>selected="selected" <?php }}?>>D</option>
                                    <option value="E" <?php if (!empty($isEdit)) {if ($details->question_set == "E") { ?>selected="selected" <?php }}?>>E</option>
                            ...
                            <div class="form-group col-sm-6 my-form-element">
                                ...
                                <select name="question_tag">
                                    ...
                                    <option value="match" <?php if (!empty($isEdit)) {if ($details->question_tag == "match") { ?>selected="selected" <?php }}?>>Match THe Following</option>
                                    <option value="fill_in" <?php if (!empty($isEdit)) {if ($details->question_tag == "fill_in") { ?>selected="selected" <?php }}?>>Fill In The Blanks</option>
                                    <option value="true_false" <?php if (!empty($isEdit)) {if ($details->question_tag == "true_false") { ?>selected="selected" <?php }}?>>True & False</option>
                            ...
                            <?php
                                   $currentDate = date('Y-m-d');
                                    ...
                                    $previous10Year = $c_year - 23;
                                    $after10Year = $c_year + 10;
                                    if(!empty($c_year_n)){
                                        $previous_n_10Year = $c_year_n - 23;
...
<!--                                <label for="textitem">Appeared Year</label>
                                ...
                                <!--<input type="text" id="datepicker" class="form-control" name="template_title" value="<?php if (!empty($isEdit)) echo $details->template_title; ?>" data-rule-required="true" />-->
                            </div>
                            
                            <div class="form-group col-sm-6 my-form-element">
                                <label for="textitem">Marks</label>
                                <input type="text" class="form-control" name="mark" value="<?php if (!empty($isEdit)) echo $details->mark; ?>"/>
                            </div>
...
<!--                                    <option value="Image" <?php if (!empty($resultQuestionArr)) {if ($Q_typeArr == "Image") {echo "selected"; }}?>>Image</option>
                            ...
                            <div class="form-group col-sm-6 my-form-element">
                                ...
                                <input type="text" class="form-control" name="question_no" id="question_no" value="<?php if (!empty($isEdit)) echo $details->question_no; ?>" data-rule-alphanumber="true"/>
                            </div>
