        ...
        //for(i=1;i< max_fields; i++){
            if(i < max_fields){ //max input box allowed
                var count = i+1;
                        ...
                        subquestion +='<div id="subquestion-'+count+'" class="subquestion">';
                            subquestion +='<button type="button" id="option_'+count+'" onclick="addSub(\'option\','+count+')" class="row btn btn-dark tabbtn"><i class="fa fa-plus-square-o fa-lg"></i> Option '+count+'</button>';
                            subquestion +='<div id="option" class="row" style="padding: 10px;border: 2px solid rgba(52, 73, 94, 0.88);"></div>';
                            subquestion +='<button type="button" id="hint_'+count+'" onclick="addSub(\'hint\','+count+')" class="row btn btn-success tabbtn"><i class="fa fa-plus-square-o fa-lg"></i> Hint '+count+'</button>';
                            subquestion +='<div id="hint" class="row" style="padding: 10px;border: 2px solid #26b99a;"></div>';
                            subquestion +='<button type="button" id="answer_'+count+'" onclick="addSub(\'answer\','+count+')" class="row btn btn-info tabbtn"><i class="fa fa-plus-square-o fa-lg"></i> Answer '+count+'</button>';
                            subquestion +='<div id="answer" class="row" style="padding: 10px;border: 2px solid #5bc0de;"></div>';
                            subquestion +='<button type="button" id="reason_'+count+'" onclick="addSub(\'reason\','+count+')" class="row btn btn-warning tabbtn"><i class="fa fa-plus-square-o fa-lg"></i> Reason '+count+'</button>';
                            subquestion +='<div id="reason" class="row" style="padding: 10px;border: 2px solid #f0ad4e;"></div>';
                            subquestion +='<button type="button" id="description_'+count+'" onclick="addSub(\'description\','+count+')" class="row btn btn-primary tabbtn"><i class="fa fa-plus-square-o fa-lg"></i> Description '+count+'</button>';
...
//                    input +='</div>';
//                //$('#'+option).append(input);
//                $('#withoutSubquestion').find('#'+option).append(input);
//            }
//      }
