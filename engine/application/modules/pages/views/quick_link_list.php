 ...
 <div class="container-fluid">
     <div class="page-header">
         ...
         <div class="pull-right">
            <div class="btn-group">
<a class="btn btn-primary" href="<?php echo base_url("admin/pages/quick_link_add")?>">Create/add new <?php echo ucfirst($link);?> <i class="fa fa-plus"></i></a>
...
<!--                    <td class="center hidden-phone"><a href="javascript:void();" id="<1?php echo $catTrek->id?>"><1?php echo $catTrek->status?></a></td>-->
                                    <td>
                                        <a class="edit" href="<?php echo base_url("admin/pages/quick_link_edit/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>
                                                                    Are you sure to delete the Newsletters <strong><?php echo $row->page_title;?></strong>.<br/>
                                                                </p>
                                                            </div>
                                                            <!-- /.modal-body -->
                                                            <div class="modal-footer">
                                                                <a href="<?php echo base_url("admin/pages/quick_link_delete/$edit_id");?>" class="btn btn-danger">Delete</a>
