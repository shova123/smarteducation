    ...
    $(function () {
        $('#home_image').uploadifive({
            ...
            'formData': {
                ...
                'targetFolder': '/skylarks/uploads/travel_info/',
            ...
            'onUploadComplete': function (file, data, response) {
                ...
                $('.imagethumbs-form').prepend('<div class="imagethumb-form additional-file-input" id="add-image1" > <a class="close-msg" title="Delete" id="deleteImg">Delete</a> <a href="#" title="'+data+'" class="img-wrap"><img src="'+"<?php echo base_url();?>"+'gears/admin/createThumb/create_thumb.php?src='+imagePath+'uploads/travel_info/'+data+'&w=150&h=150" alt="'+data+'" /></a></div>');
                                ...
                                ?>
                                    <div class="imagethumb-form additional-file-input" id="add-image1">
                                        ...
                                        <a href="#" title="<?php echo $i;?>" class="img-wrap">
                                            <img src="<?php echo base_url();?>gears/admin/createThumb/create_thumb.php?src=<?php echo ROOT;?>uploads/travel_info/<?php echo $i;?>&w=150&h=150" />
                                        </a>  
                                    </div>
                                <?php       
                                            }
