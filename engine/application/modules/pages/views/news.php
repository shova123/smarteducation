...
$(function(){	
    $('.publish_status a').click(function(){ 
        ...
        $.get('<?php echo base_url('pages/news_update_status');?>', {id : _id, status : _status},
		//alert(data);
            function(data){
                _this.text(data);
				$('a#'+_id+'').addClass(data);
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <a class="btn btn-round btn-primary" href="<?php echo base_url("pages/news_add")?>"> Add new Page <i class="fa fa-plus"></i></a>
        </div>
                            ...
                            <?php if(!empty($news)){
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="edit" href="<?php echo base_url("pages/news_edit/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Are you sure to delete the Page <strong><?php echo $row->heading;?></strong>.<br/>
                                                            </p>
                                                        </div>
                                                        <!-- /.modal-body -->
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("pages/news_delete/$edit_id") ?>" class="btn btn-danger">Delete</a>
