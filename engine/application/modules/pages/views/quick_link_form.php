    ...
    $(function () {
        $('#home_image').uploadifive({
            ...
            'formData': {
                ...
                'targetFolder': '/uploads/quick_links/',
...
$(document).on('click', 'a#deleteImg', function () {
		...
		var _this = $(this).parent();
                delete_image(_img);
		$.post("<?php echo admin_url("quick_links/newsletters_delete_image");?>",{imgName:_img},
		function(data){
                ...
                <div class="box-content nopadding">
                    <form action="" method="post" class="form-horizontal form-bordered form-validate" enctype='multipart/form-data' >
                        ...
                        <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Newsletter Title</label>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="textfield" class="control-label col-sm-2">Images</label>
                            <div class="col-sm-10">
                                ...
                                ?>
                                    <div class="imagethumb-form additional-file-input" id="add-image1">
                                        ...
                                        <a href="#" title="<?php echo $i;?>" class="img-wrap">
                                            <img src="<?php echo base_url();?>gears/admin/createThumb/create_thumb.php?src=<?php echo ROOT;?>uploads/quick_links/<?php echo $i;?>&w=150&h=150" />
                                        </a>  
                                    </div>
                                <?php       
                                            }
