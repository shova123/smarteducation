...
<div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_type">Select Course<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="department_id"  id="department_id" class=' form-control' data-rule-required="true">
...
<!--                                <span class="input-group-btn">
                                    <button type="button" class="remove_unit btn btn-danger"><i class="fa fa-trash"></i></button>
                                </span>-->
                            </div>
...
//                var yearOption='<option value="" selected="selected">---Select Year---</option>';
//                var semesterOption='<option value="" selected="selected">---Select Semester---</option>';
...
//        add +='<span class="input-group-btn">';
//            add +='<button type="button" class="remove_unit btn btn-danger"><i class="fa fa-trash"></i></button>';
//        add +='</span>';
