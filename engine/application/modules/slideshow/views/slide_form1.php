    ...
    $(function () {
        $('#imgname').uploadifive({
            ...
            'formData': {
                ...
                'targetFolder': '/skylarks/uploads/slides/',
...
$(document).on('click', 'a#deleteImg', function () {
		...
		var _this = $(this).parent();
                delete_image(_img);
		$.post("<?php echo admin_url("slideshow/delete_image");?>",{imgName:_img},
		function(data){
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-color box-bordered">
                ...
                <div class="box-describe nopadding">
                    <form action="" method="post" class="form-horizontal form-bordered form-validate" enctype='multipart/form-data' >
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                        <input type="text" name="title" id="title" value="<?php if (@$isEdit) echo $details->title; ?>" class="form-control">
                                        <span class="help-block">This is just a supporting text</span>
                                </div>
                        </div>
                        <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Slide Content</label>
                                <div class="col-sm-10">
                                        <textarea name="describe" id="describe" class="form-control ckeditor"><?php if (@$isEdit) echo $details->describe; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <span class="help-block">Image Size 1920*680 ( Best Fit )</span>
                                <div id="queueImage"></div>
                                <input id="imgname" name="imgname" type="file" multiple="true">
