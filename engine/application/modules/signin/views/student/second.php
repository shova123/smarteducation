								...
								<div class="col-sm-4">
									<ul class="custom-list">
                                                                            <?php  foreach ($rows as $row) {
                                                                                $pastSubjecttoken=$row['token'];
                                                                                ?>
										<li><a href="<?php echo base_url();?>subject/<?php echo $pastSubjecttoken;?>"><?php echo $row['subject_name'];?> <small>-<?php echo $row['tt'];?></small></a></li>
                                                                                <?php } ?>
...
<!--										<li><a href="chapter.php">Mathematics 50 Sets Practice <small>-12</small></a></li>
		...
		<div class="col-sm-4 col-md-3 sidebar-ad">
			<div class="ad-sidebar">
				<img src="http://files2.coloribus.com/files/adsarchive/part_1353/13535555/file/centennial-college-einstein-small-56912.jpg" class="img-responsive" alt="">
			</div>
		</div>
	</div>
</div>
