            ...
            <div class="row">
                <div class="sample-form-elements">
                    ...
                    <?php if (!empty($isEdit) && !empty($details->year)) { ?>
                        <div class="form-group col-sm-6 my-form-element" id="year">
                            ...
                            <select name="year" id="year" class=' form-control' tabindex="-1" >
                                ...
                                <option value="1" <?php
                                if (($isEdit) && ($details->year == '1')) {
                                    echo "selected";
                                }
                                ?>> 1 </option>
                                <option value="2" <?php
                                if (($isEdit) && ($details->year == '2')) {
                                    echo "selected";
                                }
                                ?>> 2 </option>
                                <option value="3" <?php
                                if (($isEdit) && ($details->year == '3')) {
                                    echo "selected";
                                }
                                ?>> 3 </option>
                                <option value="4" <?php
                                if (($isEdit) && ($details->year == '4')) {
                                    echo "selected";
                                }
                                ?>> 4 </option>
                                <option value="5" <?php
                                if (($isEdit) && ($details->year == '5')) {
                                    echo "selected";
                                }
                                ?>> 5 </option>
                                <option value="6" <?php
                                if (($isEdit) && ($details->year == '6')) {
                                    echo "selected";
                                }
                                ?>> 6 </option>
                                <option value="7" <?php
                                if (($isEdit) && ($details->year == '7')) {
                                    echo "selected";
                                }
                                ?>> 7 </option>
                                <option value="8" <?php
                                if (($isEdit) && ($details->year == '8')) {
                                    echo "selected";
                                }
                                ?>> 8 </option>
                                <option value="9" <?php
                                if (($isEdit) && ($details->year == '9')) {
                                    echo "selected";
                                }
                                ?>> 9 </option>
                                <option value="10" <?php
                                if (($isEdit) && ($details->year == '10')) {
                                    echo "selected";
                                }
                                ?>> 10 </option>
                            </select>
                    ...
                    <?php if (!empty($isEdit) && !empty($details->semester)) { ?>
                        ...
                        <div class="form-group col-sm-6 my-form-element" id="semester">
                            ...
                            <select name="semester" id="semester" class='select2_single form-control' tabindex="-1" >
                                ...
                                <option value="1" <?php
                                if (($isEdit) && ($details->semester == '1')) {
                                    echo "selected";
                                }
                                ?>> 1 </option>
                                <option value="2" <?php
                                if (($isEdit) && ($details->semester == '2')) {
                                    echo "selected";
                                }
                                ?>> 2 </option>
                                <option value="3" <?php
                                if (($isEdit) && ($details->semester == '3')) {
                                    echo "selected";
                                }
                                ?>> 3 </option>
                                <option value="4" <?php
                                if (($isEdit) && ($details->semester == '4')) {
                                    echo "selected";
                                }
                                ?>> 4 </option>
                                <option value="5" <?php
                                if (($isEdit) && ($details->semester == '5')) {
                                    echo "selected";
                                }
                                ?>> 5 </option>
                                <option value="6" <?php
                                if (($isEdit) && ($details->semester == '6')) {
                                    echo "selected";
                                }
                                ?>> 6 </option>
                                <option value="7" <?php
                                if (($isEdit) && ($details->semester == '7')) {
                                    echo "selected";
                                }
                                ?>> 7 </option>
                                <option value="8" <?php
                                if (($isEdit) && ($details->semester == '8')) {
                                    echo "selected";
                                }
                                ?>> 8 </option>
                                <option value="9" <?php
                                if (($isEdit) && ($details->semester == '9')) {
                                    echo "selected";
                                }
                                ?>> 9 </option>
                                <option value="10" <?php
                                if (($isEdit) && ($details->semester == '10')) {
                                    echo "selected";
                                }
                                ?>> 10 </option>
                            </select>
                            ...
                            <select name="course_id"  id="course_id" class=' form-control' onchange="setUnit(document.addEditform.unit_id.options[document.addEditform.unit_id.selectedIndex].value);"  tab-index="-1" data-rule-required="true">
                                ...
                                foreach ($courses as $course) {
                                    ...
                                    if ($details->stream_id == $courseStreamID) {
                                        ...
                                        <option value="<?php echo $courseIDs; ?>" <?php
                                        if (($isEdit) && ($details->unit_id == $courseIDs)) {
                                            echo "selected";
                                        }
                                        ?>> <?php echo $courseName; ?> </option>
                                                <?php
                            ...
                            <select name="course_id"  id="course_id" class=' form-control' onchange="setCourse(document.addEditform.course_id.options[document.addEditform.course_id.selectedIndex].value);"  tab-index="-1" data-rule-required="true">
                                ...
                                foreach ($courses as $course) {
                                    ...
                                    if ($details->stream_id == $courseStreamID) {
                                        ...
                                        <option value="<?php echo $courseIDs; ?>" <?php
                                        if (($isEdit) && ($details->subunit_id == $courseIDs)) {
                                            echo "selected";
                                        }
                                        ?>> <?php echo $courseName; ?> </option>
                                                <?php
                    ...
                    <div class="form-group col-sm-6 my-form-element">
                        ...
                        <select name="set">
                            <option value="A" <?php
                            if (($isEdit) && ($details->question_set == "A")) {
                                echo "selected";
                            }
                            ?>>A</option>
                            <option value="B" <?php
                            if (($isEdit) && ($details->question_set == "B")) {
                                echo "selected";
                            }
                            ?>>B</option>
                            <option value="C" <?php
                            if (($isEdit) && ($details->question_set == "C")) {
                                echo "selected";
                            }
                            ?>>C</option>
                        </select>   
                ...
                <div class="form-group col-sm-4 my-form-element">
                    ...
                    <select name="appeared_year" class="ui-datepicker-year" data-event="change" data-handler="selectYear">
                        ...
                        if (($isEdit) && ($details->appeared_year == "2005")) {
                            echo "selected";
                        }
                        ?>>2005</option>
                        <option value="2006" <?php
                        if (($isEdit) && ($details->appeared_year == "2006")) {
                            echo "selected";
                        }
                        ?>>2006</option>
                        <option value="2007" <?php
                        if (($isEdit) && ($details->appeared_year == "2007")) {
                            echo "selected";
                        }
                        ?>>2007</option>
                        <option value="2008" <?php
                        if (($isEdit) && ($details->appeared_year == "2008")) {
                            echo "selected";
                        }
                        ?>>2008</option>
                        <option value="2009" <?php
                        if (($isEdit) && ($details->appeared_year == "2009")) {
                            echo "selected";
                        }
                        ?>>2009</option>
                        <option value="2010" <?php
                        if (($isEdit) && ($details->appeared_year == "2010")) {
                            echo "selected";
                        }
                        ?>>2010</option>
                        <option value="2011" <?php
                        if (($isEdit) && ($details->appeared_year == "2011")) {
                            echo "selected";
                        }
                        ?>>2011</option>
                        <option value="2012" <?php
                        if (($isEdit) && ($details->appeared_year == "2012")) {
                            echo "selected";
                        }
                        ?>>2012</option>
                        <option value="2013" <?php
                        if (($isEdit) && ($details->appeared_year == "2013")) {
                            echo "selected";
                        }
                        ?>>2013</option>
                        <option value="2014" <?php
                        if (($isEdit) && ($details->appeared_year == "2014")) {
                            echo "selected";
                        }
                        ?>>2014</option>
                        <option value="2015" <?php
                        if (($isEdit) && ($details->appeared_year == "2015")) {
                            echo "selected";
                        }
                        ?>>2015</option>
                        <option <?php
                        if (($isEdit) && ($details->appeared_year == "2016")) {
                            echo "selected";
                        }
                        ?> value="2016">2016</option>
                        <option value="2017" <?php
                        if (($isEdit) && ($details->appeared_year == "2017")) {
                            echo "selected";
                        }
                        ?>>2017</option>
                        <option value="2018" <?php
                        if (($isEdit) && ($details->appeared_year == "2018")) {
                            echo "selected";
                        }
                        ?>>2018</option>
                        <option value="2019" <?php
                        if (($isEdit) && ($details->appeared_year == "2019")) {
                            echo "selected";
                        }
                        ?>>2019</option>
                        <option value="2020" <?php
                        if (($isEdit) && ($details->appeared_year == "2020")) {
                            echo "selected";
                        }
                        ?>>2020</option>
                        <option value="2021" <?php
                        if (($isEdit) && ($details->appeared_year == "2021")) {
                            echo "selected";
                        }
                        ?>>2021</option>
                        <option value="2022" <?php
                        if (($isEdit) && ($details->appeared_year == "2022")) {
                            echo "selected";
                        }
                        ?>>2022</option>
                        <option value="2023" <?php
                        if (($isEdit) && ($details->appeared_year == "2023")) {
                            echo "selected";
                        }
                        ?>>2023</option>
                        <option value="2024" <?php
                        if (($isEdit) && ($details->appeared_year == "2024")) {
                            echo "selected";
                        }
                        ?>>2024</option>
                        <option value="2025" <?php
                        if (($isEdit) && ($details->appeared_year == "2025")) {
                            echo "selected";
                        }
                        ?>>2025</option>
                        <option value="2026" <?php
                        if (($isEdit) && ($details->appeared_year == "2026")) {
                            echo "selected";
                        }
                        ?>>2026</option>
                    </select>
