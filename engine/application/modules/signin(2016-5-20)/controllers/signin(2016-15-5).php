...
//        if (!$this->ion_auth->logged_in() && get_cookie('identity') && get_cookie('remember_code'))
//        {//echo get_cookie('identity');
//        //echo get_cookie('remember_code');
...
//        }
    ...
    function login() {
        $data['title'] = "Login";
        //validate form input
        $this->form_validation->set_rules('identity', 'Identity', 'required|callback_terminal_login_check');
        $this->form_validation->set_rules('password', 'Password', 'required');
        
        //############# funtion for linkedin login checkup start
        ...
        //$data['link'] = "https://api.linkedin.com/uas/oauth/authorize?oauth_token=" . $token['linkedin']['oauth_token'];
        $data['link'] = "https://www.linkedin.com/uas/oauth/authorize?oauth_token=". $token['linkedin']['oauth_token'];
        //############# funtion for linkedin login checkup end
...
//        }
    ...
    function terminal_login_check() 
    {
      ...
      $user_detailed = $this->signin_model->get_byId("users","email",$email);
      $user_idss = $user_detailed->user_id;
      //echo $user_idss;die;
      //$groupTypeDashboardName = $this->ion_auth->has_dashboardByID($user_idss);
      return true;
      // LOAD MODEL HERE
...
//      {
//          
//        //$this->session->set_flashdata('error_message', "Please change the tab to Company to log in.");
//        $this->form_validation->set_message('message', 'Please change the tab to Company to log in.');
//        return false;
//      } else if($groupTypeDashboardName == "users")
//      {
//         // $this->session->set_flashdata('error_message', "Please change the tab to Candidate to log in.");
//        $this->form_validation->set_message('message', 'Please change the tab to Candidate to log in.');
//        return false;
//      }else{
//          return true;
//      }
