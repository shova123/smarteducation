...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <a class="btn btn-round btn-primary" href="<?php echo base_url("admin/upload/add_syllabus")?>"> Add new Syllabus <i class="fa fa-plus"></i></a>
        </div>
                                ...
                                ?>
                                    ...
                                    <tr>
                                       ...
                                       <td class="publish_status">
                                            <a href="javascript:;" id="<?php echo $row->syllabus_id; ?>"  style="margin:5px; padding:5px 10px;<?php if (!empty($active)) { ?>background-color: #006600;<?php } ?>" class="badge">
                                                <?php
                                                if ($row->status == 1)
                                                    echo 'Active';
                                                else
                                        ...
                                        <td style="padding:10px!important">
                                            ...
                                            <a class="edit" href="<?php echo base_url("upload/admin/edit_syllabus/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("admin/upload/delete_syllabus/$edit_id") ?>" class="btn btn-danger">Delete</a>
