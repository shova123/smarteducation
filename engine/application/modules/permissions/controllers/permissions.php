...
//        }
    ...
    function create_permissions() {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            $syllabusIncludeMethods['upload/admin'] = array('syllabus_list','add_syllabus','edit_syllabus','delete_syllabus');
            
            $settingsIncludeMethods['settings/settings'] = array('settings_list','settings_add', 'settings_edit', 'settings_delete');
            
            $data['ModuleControllerMethods'] = $controllerMethods = array_merge($signinIncludeMethods, $userIncludeMethods, $courseIncludeMethods,$dataIncludeMethods,$pagesIncludeMethods,$settingsIncludeMethods,$syllabusIncludeMethods);
