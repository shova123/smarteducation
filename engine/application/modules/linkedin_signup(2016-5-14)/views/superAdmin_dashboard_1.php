                    ...
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('index_groups_th')."(Group Type)"; ?></th>
                                    ...
                                    <tr><!--gradeA, gradeC, gradeX, gradeU -->
                                        ...
                                        <td>
                                            <?php foreach ($user->groups as $group): ?>
                                                <?php echo anchor("signin/edit_group/" . $group->group_id, htmlspecialchars($group->name, ENT_QUOTES, 'UTF-8'))." (". ucfirst($groupType).")"; ?><br />
                                            <?php endforeach ?>
                                        </td>
