...
<!--                            <select class="form-control" name="package_name" > name is used as value obtainer for select changes
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="first_name" id="first_name" value="<?php if (@$isEdit) {echo $details->first_name;}?>" class="slug_name form-control" data-rule-required="true" >
...
<!--                        </div>
                        ...
                        <div class="form-group">-->
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="last_name" id="last_name" value="<?php if (@$isEdit) {echo $details->last_name;}?>" class="slug_name form-control" data-rule-required="true" >
                                <!--<span class="help-block">This is just a Job Filed Type</span>-->
                            </div>
                        </div>
...
<!--                        <div class="form-group">
                ...
                <div class="box box-color box-bordered">
                    ...
                    <div class="box-content nopadding">
                            <div class="form-group">
                                <label for="groups" class="control-label col-sm-2">Group Names</label>
                                <div class="col-sm-6">
                                        ...
                                        <?php foreach ($groups as $group) { ?>
                                            <div class="check-line">
                                                ...
                                                if (strpos("superAdmin", $groupTYPE) !== false) {//check if logged in user is super admin type then allow
                                                    if ((strpos("superAdmin", $gTYPE) !== false) || (strpos("manager", $gTYPE) !== false) || (strpos("company", $gTYPE) !== false) || (strpos("users", $gTYPE) !== false)) {
                                                        ?>
                                                    ...
                                                    if ((strpos("company", $gTYPE) !== false) || (strpos("users", $gTYPE) !== false)) {
                                                        ?>
                                                        <input type="radio" name="groups[]" value="<?php echo $group['group_id']; ?>"<?php echo $checked; ?> id="c9" class='icheck-me' data-skin="square" data-color="red">
                                                        <label class='inline' for="c9"><?php echo htmlspecialchars($group['name'], ENT_QUOTES, 'UTF-8'); ?></label>
                                                        <?php
                                                    }
                                                }elseif (strpos("company", $groupTYPE) !== false) {
