            ...
            <div class="sample-form-elements">
                <form action="" method="post" name="addEditform" id="addEditform" class="form-validate" enctype='multipart/form-data' accept-charset="utf-8">
                    ...
                    <div class="form-group col-sm-4 my-form-element">
                        ...
                        <select name="category_id" id="category_id" class="form-control" onchange="setCategory(document.addEditform.category_id.options[ document.addEditform.category_id.selectedIndex].value);" data-rule-required="true">
                    ...
                    <div class="form-group col-sm-4 my-form-element">
                        ...
                        <select name="sub_cat_id" id="sub_cat_id" class='form-control' onchange="setSubCategory(document.addEditform.sub_cat_id.options[ document.addEditform.sub_cat_id.selectedIndex].value);" data-rule-required="true" >
                    ...
                    <div class="form-group col-sm-4 my-form-element">
                        <label for="textitem">Templates <span style="color: #cc0000;">*</span></label>
                        <select name="temp_id" id="temp_id" onchange="setTemplates(document.addEditform.temp_id.options[ document.addEditform.temp_id.selectedIndex].value);" class='form-control' data-rule-required="true">
                    ...
                    <div class="form-group col-sm-12 my-form-element">
                        <label for="subject">Subject <span style="color: #cc0000;">*</span></label>
                        <input type="text" name="subject" id="subject" class="form-control" value="<?php if (!empty($isEdit)){echo $report_details->subject;}?>" data-rule-required="true" >
                    </div>
                    <div class="form-group col-sm-12 my-form-element">
                        <label for="textitem">Message <span style="color: #cc0000;">*</span></label>
                        <textarea name="content" id="content" data-rule-required="true" class="form-control ckeditor"><?php
                            if (@$isEdit) {
