<script>
    $(function () {
        $('.publish_status a').click(function () {
            ...
            $.get('<?php echo base_url("admin/users/update_template_status"); ?>', {id: _id, status: _status},
            //alert(data);
            function (data) {
                _this.text(data);
                $('a#' + _id + '').addClass(data);
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="pull-right">
            <div class="btn-group">
                <a class="btn btn-primary" href="<?php echo base_url('admin/users/template_add') ?>">Create/Add new Templates <i class="fa fa-plus"></i></a>
            </div>
            ...
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3>
                        ...
                        <p>View / Edit existing Packages</p>
                    </h3>
                </div>
                    ...
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <tbody>
                            ...
                            if (!empty($template_lists)) {
                                $count = 1;
                                foreach ($template_lists as $templatesDET) {
                            ...
                            ?>
                                    ...
                                    <tr><!--gradeA, gradeC, gradeX, gradeU -->
                                        <td><?php if(!empty($userFullName)){echo htmlspecialchars($userFullName,ENT_QUOTES,'UTF-8');}else{echo '-';}?></td>
                                        <td><?php if(!empty($templateTITLE)){echo htmlspecialchars($templateTITLE,ENT_QUOTES,'UTF-8');}else{echo '-';}?></td>
                                        <td>
                                            
                                                    <a href="<?php echo base_url("admin/users/template_view/$templateTOKEN"); ?>" class="btn btn-success" rel="tooltip" title="<?php if (!empty($userFullName)) {echo "View $userFullName's Template In New Tab";}?>" data-placement="top">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                    <a href="<?php echo base_url("admin/users/other_template_edit/$templateTOKEN"); ?>" class="btn btn-warning" rel="tooltip" title="<?php if (!empty($userFullName)) {echo "Copy $userFullName's Template For Another Teachers";}?>" data-placement="bottom"><i class="fa fa-copy"></i> Copy</a>
...
<!--                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a class="edit" href="<?php echo base_url("admin/users/template_edit/$templateTOKEN") ?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Are you sure to delete <?php echo $templateTITLE; ?> Template of Teacher :<?php echo $userFullName; ?> 
                                        If You Delete The Template all the related Questions and Answers will be deleted automatically
                                                            </p>
                                                        </div>
                                                        <!-- /.modal-body -->
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("admin/users/template_delete/$templateTOKEN") ?>" class="btn btn-danger">Delete</a>
