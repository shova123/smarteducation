...
//        }
	...
	{ 
        ...
        function get_row($table, $fieldName=null, $name=null,$fieldName1=null, $name1=null,$order=null)
	{
            $this->db->select("*");
            if(!empty($name)){
                $this->db->where( $fieldName, $name);
        ...
        function get_rowLike($table, $fieldName=null, $name=null,$fieldName1=null, $name1=null,$order=null)
	{
            $this->db->select("*");
            if(!empty($name)){
                $this->db->where( $fieldName, $name);
