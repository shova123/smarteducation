<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo base_url();?>" class="site_title"><i class="fa fa-book"></i> <span>SmartSikshya</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-image"></i> Page Manager <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="<?php echo base_url("pages/page_list");?>"> Content Manager</a>
                            </li>
                            <li><a href="<?php echo base_url("pages/news_list");?>">News Manager</a>
                            </li>
                    ...
                    <li><a><i class="fa fa-image"></i> Image Manager <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            ...
                            <li><a href="<?php echo base_url();?>pages/gallery_list">Gallery</a>
                            </li>
                            <li><a href="<?php echo base_url();?>pages/videos">Video</a>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<!--                    <li><a><i class="fa fa-windows"></i> Course Manager <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-windows"></i> Data Manager <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            ...
                            <li><a href="<?php echo base_url("data/list_question/$levelSlug");?>"><?php echo $levelName?></a>
                            </li>
                            <?php }
                            endif;
                            ?>
                      ...
                      <li><a href="<?php echo base_url();?>admin/upload/syllabus_list"><i class="fa fa-windows"></i>Upload</a>
