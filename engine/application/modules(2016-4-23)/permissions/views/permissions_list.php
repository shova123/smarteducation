        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <table id="example" class="table table-striped responsive-utilities jambo_table dataTable dataTable-column_filter" data-column_filter_types="text,select,text,select,text,null" data-column_filter_dateformat="dd-mm-yy"  data-nosort="0" data-checkall="all">
                        <thead>
                            <tr class="headings">
<!--                                <th>
...
<!--                                <td class="a-center ">
                                ...
                                <td><?php echo $permission_title;?></td>
                                ...
                                <td class="last">
                                        <a class="btn" href="<?php echo base_url("permissions/edit_permissions/".$token) ?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
