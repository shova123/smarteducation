            ...
            <div class="sample-form-elements">
                ...
                <?php if(@$isEdit){?><input type="hidden" name="user_id" value="<?php echo $user->user_id?>"/><?php }?>
                    ...
                    <div class="form-group col-sm-6 my-form-element">
                        ...
                        <input type="tel" name="phone" id="phone" value="<?php if (@$isEdit) {echo $details->phone;}?>" class="form-control" data-rule-mobileAU="true" placeholder="Your Mobile Number : 61 xxx xxx xxx">
                    </div>
