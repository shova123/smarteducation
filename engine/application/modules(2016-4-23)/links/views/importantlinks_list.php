...
$(function(){	
    $('.publish_status a').click(function(){ 
        ...
        $.get('<?php echo admin_url('admin/link_update_status');?>', {id : _id, status : _status},
		//alert(data);
            function(data){
                _this.text(data);
				$('a#'+_id+'').addClass(data);
        ...
        <div class="col-md-12">
         ...
         <div class="porlets-content">
          <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a class="btn btn-primary" href="<?php echo base_url('admin/links/link_add')?>">Create/add new Important Links <i class="fa fa-plus"></i></a>
...
<!--                                    <th>Delete</th>-->
                    ...
                    <tr class="gradeA"><!--gradeA, gradeC, gradeX, gradeU -->
                        ...
                        <td  class="text-center"><a class="edit" href="<?php echo base_url("admin/links/link_edit/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a></td>
                        <td class="text-center"><a class="delete" href="<?php echo base_url("admin/links/link_delete/$edit_id")?>"><button class="btn btn-xs btn-danger"><i class="fa fa-times"></i></button></a></td>
                    </tr>
                    <?php $count++;}}?>
