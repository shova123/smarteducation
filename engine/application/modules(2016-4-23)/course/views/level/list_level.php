        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <table id="example" class="table table-striped responsive-utilities jambo_table dataTable dataTable-column_filter" data-column_filter_types="null,text,select,select,null,null" data-column_filter_dateformat="dd-mm-yy"  data-nosort="0" data-checkall="all">
                        <thead>
                            <tr class="headings">
<!--                                <th>
                                    ...
                                    $count = 1;
                                        foreach($levels as $row){
                                            ...
                                            $resultBoard = $queryBoard->row(); 
                                                ...
                                                if(!empty($boardName)){$boardName =$boardName;}else{$boardName='-';}
                                ?>

                                    <tr>
                                        <td style="text-align:left;"><?php echo $count?></td>
                                        <td><strong><?php echo $row->level_name;?></strong></td>
                                        <td><?php echo ucfirst($row->level_type);?></td>
                                        <td><?php echo ucfirst($boardName);?></td>
                                       ...
                                       <td class="publish_status">
                                        ...
                                        <td>
                                            <a class="edit" href="<?php echo base_url("course/edit_level/$level_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("course/delete_level/$level_id") ?>" class="btn btn-danger">Delete</a>
