...
$(function(){	
    $('.publish_status a').click(function(){ 
        ...
        $.get('<?php echo base_url('course/update_status_course');?>', {id : _id, status : _status},
		//alert(data);
            function(data){
                _this.text(data);
				$('a#'+_id+'').addClass(data);
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <a class="btn btn-round btn-primary" href="<?php echo base_url("course/add_course")?>"> Add new Course <i class="fa fa-plus"></i></a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="example" class="table table-striped responsive-utilities jambo_table dataTable dataTable-column_filter" data-column_filter_types="null,select,select,null,null,null" data-nosort="0" data-checkall="all">
                        <thead>
                            <tr class="headings">
<!--                                <th>
...
//                                                $levelBoardId = @$resultLevel->board_id;
//                                                
//                                                $this->db->select('*');
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $courseName;?>
                                            ( <a data-toggle='tooltip' data-placement='top' title='<?php echo ucfirst($boardName);?>'><?php echo $boardAliasName;?></a> )
                                        </td>
                                        
                                        
                                       <td class="publish_status">
                                            <a href="javascript:;" id="<?php echo $row->course_id; ?>"  style="margin:5px; padding:5px 10px;<?php if (!empty($active)) { ?>background-color: #006600;<?php } ?>" class="badge">
                                                <?php
                                                if ($row->status == 1)
                                                    echo 'Active';
                                                else
                                        ...
                                        <td>
                                            <a class="edit" href="<?php echo base_url("course/edit_course/$course_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Are you sure to delete the Level  <strong><?php echo $row->course_name;?></strong>.<br/>
                                                            </p>
                                                        </div>
                                                        <!-- /.modal-body -->
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("course/delete_course/$course_id") ?>" class="btn btn-danger">Delete</a>
