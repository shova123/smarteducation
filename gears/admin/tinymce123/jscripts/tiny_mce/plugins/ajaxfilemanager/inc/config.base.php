...
//	define('CONFIG_SYS_ROOT_PATH', '../../../../uploaded/');	//accept relative path only
        define('CONFIG_SYS_DEFAULT_PATH', CONFIG_SYS_MY_DOCROOT.'/ajax_uploaded/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_MY_DOCROOT.'/ajax_uploaded/');	//accept relative path only 
